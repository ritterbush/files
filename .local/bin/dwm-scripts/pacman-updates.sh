...
case $BUTTON in 
    1) alacritty -e zsh -c '(zsh & source ~/.zshrc) && sudo pacman -Sy';;
    2) alacritty -e zsh -c 'zsh & source ~/.zshrc & nvim ~/Programs/dwm/config.def.h';;
    3) alacritty -e zsh -c 'zsh & source ~/.zshrc & nvim ~/.local/bin/dwm-scripts/pacman-updates.sh';;
